...
An Android Application developed by Team The Minions (@MayarAlaa,@nairaAli,@MernaMaher,@minagamal13) to solve Linear Systems of two and three variables. The user takes a photo of the equations and the application gives the solution back.
